...
class InstallLibertyTask extends AbstractLibertyTask {
    ...
    boolean checkAndLoadInstallExtensionProperties(Map<String,String> props) {
    ...
    Map<String, String> buildInstallLibertyMap(Project project) {
    ...
    void loadLibertyRuntimeProperties() {
